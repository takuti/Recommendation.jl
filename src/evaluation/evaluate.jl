...
function validate_size(recommender::Recommender, truth_da::DataAccessor)
    n_rec_user, n_rec_item = size(recommender.da.R)
...
function evaluate(recommender::Recommender, truth_da::DataAccessor,
                  metric::AccuracyMetric, k::Int=0)
    check_build_status(recommender)
    n_user, n_item = validate_size(recommender, truth_da)
